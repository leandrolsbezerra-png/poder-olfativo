...
MANUAL = {
    ...
    "ysl la nuit de l'homme":         ("Yves Saint Laurent","La Nuit de L'Homme"),
    "azzaro wanted edp":              ("Azzaro",            "Wanted"),
    "burberry goddess edp":           ("Burberry",          "Goddess"),
    "burberry her edp":               ("Burberry",          "Her"),
    "burberry hero edp":              ("Burberry",          "Hero"),
    "chanel chance eau tendre edt":   ("Chanel",            "Chance Eau Tendre"),
    "coach for men edt":              ("Coach",             "for Men"),
    "dior sauvage edp":               ("Dior",              "Sauvage"),
    "versace eros edp":               ("Versace",           "Eros"),
